...
resource "azurerm_key_vault_secret" "ssh_public_key" {
  count        = var.generate_admin_ssh_key == true ? 1 : 0
  name         = "${var.vmscaleset_name}--cpp-module-terraform-azurerm-vmss--${var.environment}--vmss-ssh-public-key"
...
resource "azurerm_key_vault_secret" "ssh_private_key" {
  count        = var.generate_admin_ssh_key == true ? 1 : 0
  name         = "${var.vmscaleset_name}--cpp-module-terraform-azurerm-vmss--${var.environment}--vmss-ssh-private-key"
